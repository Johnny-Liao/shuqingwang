	...
	<body>
		...
		<div style="width: 962px; margin: auto;">
			<a href="#" target="_blank">
				<img src="../images/default/book_banner_081203.jpg" border="0" /> 
			</a>
		</div>
		...
		<div class="book">
			...
			<div class="book_center">
				...
				<div class="second_c_border1" id="recommend">
					<s:action name="recommendBook" executeResult="true"/>
				</div>
				<!--推荐图书结束-->

				<!--热销图书开始-->
				<div class="book_c_border2" id="hot">
					<s:action name="findHotBook" executeResult="true"/>
				</div>
				<!--热销图书结束-->

				<!--最新上架图书开始-->
				<div class="book_c_border2" id="new">
				  <s:action name="findNewBook" executeResult="true"/>
				</div>
				<!--最新上架图书结束-->
			...
			<div class="book_right">
				<div class="book_r_border2" id="__XinShuReMai">
					<div class="book_r_b2_1x" id="new_bang">
						...
						<s:action name="findHotNewBook" executeResult="true"/>
