...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="../js/checkUserRegist.js"></script>
	</head>
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="register" id="regist_form">
				<h2>
					以下均为必填项
				</h2>
				<table class="tab_login" >
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="verifyCode" />
							<input name="number" type="text" id="txtVerifyCode"
								class="yzm_input"/>
							<div class="text_left t1">
								<p class="t1">
									<span id="vcodeValidMsg">请输入图片中的五个字符。</span>
